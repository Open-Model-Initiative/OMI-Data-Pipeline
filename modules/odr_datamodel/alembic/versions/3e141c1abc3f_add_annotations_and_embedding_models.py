...
def upgrade() -> None:
    ...
    op.create_table('embedding_engines',
    ...
    op.create_table('annotation_embeddings',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('annotation_ratings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('annotation_id', sa.Integer(), nullable=True),
    ...
    op.create_table('annotation_reports',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('annotation_id', sa.Integer(), nullable=True),
    sa.Column('type', sa.String(), nullable=True),
    ...
    op.create_table('annotation_sources_link',
